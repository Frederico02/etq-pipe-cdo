...
class TelaPrincipal:
    def __init__(self, janela):
        ...
        nomes = ['','Arthur','Cynthia', 'Felipe', 'Fred', 'Jhones', 'Thomas',]
    ...
    def gerar(self):
        ...
        # Limpa as telas de entrada após gerar a etiqueta
        self.codigo_JIRA.set('')
        self.nome_colaborador.set('')
        self.qr.set('')
        self.ativo.set('')
